        ...
        function createMap(mapId) {
            ...
            google.maps.event.addListener(service.map, 'click', function(event) {
                ...
                '<div class="form-group">' +
                 '<label for="pType"><span>Branch Type :</span> <select name="pType" class="form-control save-type" onchange="getType(this.value);"><option value="mdc">MDC</option><option value="lka">LKA</option><option value="gt">GT</option>'+
                '</select></label>'+
                '</div>' + 
                '<div class="form-group">' +
                '<label for="pName"><span>Name :</span><input type="text" name="pName" class="form-control save-name" placeholder="Enter Name" maxlength="40" /></label>'+
                '</div>' +
                '<div class="form-group">' +
                '<label for="pAdd"><span>Address :</span><input type="text" name="pAdd" class="form-control save-add" placeholder="Enter Address" maxlength="40" /></label>'+
                '</div>' +
                '<div class="form-group">' +
                '<label for="pAvgi"><span>Average Monthly Income :</span><input type="text" name=" pAvgi" class="form-control save-avgi" placeholder="Average Monthly Income" maxlength="40" /></label>'+
                '</div>' +
                '<div class="form-group">' +
                '<label for="pAvp"><span>Average Patron :</span><input type="text" name="pAvp" class="form-control save-avgi" placeholder="Average Patron" maxlength="40" /></label>'+
                '</div>' +
                '<div class="form-group">' +
                '<label for="pDesc"><span>Remarks :</span><textarea name="pDesc" class="form-control save-desc" placeholder="Enter Remarks" maxlength="150"></textarea></label>'+
                '</div>' +
                '</form>'+
                '</div></p><button name="save-marker" class="btn btn-primary save-marker">Save Branch Details</button>  ';

                $(EditForm).appendTo('#text');
            })
