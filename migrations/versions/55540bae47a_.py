...
def upgrade():
    ...
    sa.Column('date_created', sa.DateTime(), server_default=sa.func.current_timestamp(), nullable=True),
    sa.Column('date_modified', sa.DateTime(), server_default=sa.func.current_timestamp(), nullable=True),
